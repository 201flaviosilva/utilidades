 ...
 * arrayGetMaxObjects(myArray, "b"); // 200
 * arrayGetMaxObjects(myArray, "a"); // 10
 * 
 ...
 */
export function arrayGetMaxObjects(arr, prop) { return Math.max.apply(Math, arr.map(o => o[prop])); }
